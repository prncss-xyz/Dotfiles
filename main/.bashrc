...
export PATH=$HOME/.luarocks/bin:/$HOME/.local/bin:/usr/bin:/usr/local/sbin:/usr/local/bin:/usr/lib/jvm/default/bin:/usr/bin/site_perl:/usr/bin/vendor_perl:/usr/bin/core_perl:$HOME/.pnpm-global-bin:$HOME/.cargo/bin
