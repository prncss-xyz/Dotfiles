...
map('', 'gt', '<Plug>Markdown_MoveToNextHeader', { noremap = false })
map('', 'gT', '<Plug>Markdown_MoveToPreviousHeader', { noremap = false })
map('', 'gh', '<Plug>Markdown_MoveToCurHeader', { noremap = false })
map('', 'gH', '<Plug>Markdown_MoveToParentHeader', { noremap = false })
